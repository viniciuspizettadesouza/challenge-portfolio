...
| Climate & Weather Workspace | Two Vue 2/Maps/OpenWeather challenges and Vue 3/Pinia/ApexCharts → React island                       | Combines address search, Haversine geolocation matching, history, six-hour comparison, and a 48-hour local forecast with organisation comparison, emissions aggregation, switchable charts, and validated local results |

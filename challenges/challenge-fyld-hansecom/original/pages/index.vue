      ...
      <v-container>
        ...
        <v-row>
          <v-col>
            ...
            <v-row align="center" justify="center">
              <v-text-field v-model="search" placeholder="Search movie"/>
              <v-btn type="button" @click="click">Search</v-btn>
            </v-row>
          </v-col>
        </v-row>
        ...
        <v-row>
          <v-col cols="12">
            <v-card
              v-if="showMovies"
              v-for="movie of moviesMock.results"
              elevation="2"
              class="mb-3"
            >
              <v-card-title class="text-h5">
                {{ movie.original_title }} ({{ movie.release_date.split('-', 1).toString() }})
              </v-card-title>
